    ...
    public void update() {
        ...
        if (activeEvent != null) {
	        ...
	        if(globalUpdateCount % 50 == 0){
	        	CrashTracker.logAndPrint("["+name+"] Running. timestep = " + Double.toString(globalUpdateCount*Constants.MAIN_LOOP_Ts) + "s | ActualTime = " + Double.toString(Timer.getFPGATimestamp()));
	        }
